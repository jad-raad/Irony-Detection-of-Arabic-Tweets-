...
if __name__ == "__main__":
    ...
    # Post analysis based on the best fold (non-weighted metrics)
    ...
    best_f1 = f1_score(best_fold_metrics['y_true'], (best_fold_metrics['y_pred'] > best_fold_metrics['threshold']).astype(int), average='binary')
    best_recall = recall_score(best_fold_metrics['y_true'], (best_fold_metrics['y_pred'] > best_fold_metrics['threshold']).astype(int), average='binary')
    best_precision = precision_score(best_fold_metrics['y_true'], (best_fold_metrics['y_pred'] > best_fold_metrics['threshold']).astype(int), average='binary')
